...
https://github.com/TheAlgorithms/Python/blob/master/scheduling/shortest_job_first.py
# 선점형으로 SRT 알고리즘과 동일, 참고해서 비선점형 구현하기
"""
...
def calculate_waitingtime(
    ...
    complete = 0 # 실행 완료된 프로세스의 개수
    increment_time = 0
    minm = 999999999 # 리미트
    short = 0 # 제일 짧은 프로세스
    check = False # 실행되는 프로세스
